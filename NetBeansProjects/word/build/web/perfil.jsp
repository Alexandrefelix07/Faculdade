...
%>
   ...
   <form action="perfil1.jsp" method="post" name="f1">
        ...
        <table cellspacing="1"> 
         <p>   
        <label  align="center"  >Data do Cadatro:</label><%= pessoa.getDataFormatado1() %> 
        </p>
        <tr><td><label>Cod. de Cadastro:</label></td> <td><%=pessoa.getId() %> </td></tr>
  
       <tr><td><label>Nome:</label></td> <td> <%= request.getParameter("nome")%></td></tr>    
   <tr><td><label>Sexo:</label></td> <td> <%= request.getParameter("sexo")%></td></tr>   
      <tr><td><label>Data Nascimento:</label></td> <td> <%= request.getParameter("datNasc")%> </td></tr>  
    ...
    <tr><td><label>Numero:</label></td> <td><%= request.getParameter("numero")%></td></tr>  
     ...
     <tr><td><label>Senha:</label></td> <td><%= request.getParameter("senha")%>  </td></tr>   
        ...
        <input type="submit" value="Alterar Cadastro"/></input> 
